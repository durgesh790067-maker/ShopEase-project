...
if (isset ($_POST['edit_amount'])) {
    ...
    if ($added_amount == '') {
        ...
        if ($result_query) {
            echo "<script>alert('Wallet has been updated successfully. Updated balance = ₹$new_amount'); window.location.href = 'profile_page.php?agent_id=" . $agent_id . "&wallet_history';</script>";
        }
    }
}
?>